...
void MainWindow::initTrayMenu()
{
    ...
    actionSkipBreak = menuTray->addAction("Skip the Next Break");
...
void MainWindow::foregroundLoop()
{
    ...
    ui->lblText->setText("Hi Pal, time to have a " + QString::number(FgLength) + "-second break! You have used the PC for at least: " + secondsToString(startupTime.secsTo(QDateTime::currentDateTime())));
